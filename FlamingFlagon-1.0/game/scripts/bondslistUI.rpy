...
screen bond01:
    ...
    text _("{size=55}{font=GlowSans-Bold.otf}Bond Level{/font}  [bond01]{/size}") ypos 120 xpos 70

    text _("{size=55}{font=GlowSans-Bold.otf}Bond Points{/font}  [bondexp01]{/size}") ypos 220 xpos 70

    frame:
            background None
            side ("c r"):
                area (40,320,550,600)
                viewport id "eventlist_scroller01": #REMEMBER YOUR VIEWPORT ID SO THE SCROLLBAR IS PLACED FOR IT
                    draggable True mousewheel True
                    grid 1 8:
                        xalign 0.5
                        yalign 0.5
                        ...
                        if bond01 == 0:
                            frame:
                                background "images/workday/choice_box_ss.png"
                                xsize 500
                                ysize 112
                                text _("{size=30}Bond Story 1{/size}"):
                                    yalign 0.5
                                    xpos 20
                        
                        if bond01 >= 1:
                            frame:
                                background "images/workday/choice_box_ss2.png"
                                xsize 500
                                ysize 112
                                text _("{size=30}Bond Story 1{/size}"):
                                    yalign 0.5
                        ...
                        if bond01 <= 1:
                            frame:
                                ...
                                xsize 500
                                ysize 112
                                text _("{size=30}Bond Story 2{/size}"):
                                    yalign 0.5
                                    xpos 20
                        ...
                        if gunther_sxp_1 == False and gunther_sxp_2 == False:
                            frame:
                                background "images/workday/choice_box_ss.png"
                                xsize 500
                                ysize 112
                                text _("{size=30}Gunther's Offer{/size}"):
                                    yalign 0.5
                                    xpos 20
                        
                        if gunther_sxp_1 == True or gunther_sxp_2 == True:
                            frame:
                                background "images/workday/choice_box_ss2.png"
                                xsize 500
                                ysize 112
                ...
                vbar value YScrollValue("eventlist_scroller01") #TAKES YOUR VIEWPORT ID AS THE ARG
...
screen bond02:
    ...
    text _("{size=55}{font=GlowSans-Bold.otf}Bond Level{/font}  [bond02]{/size}") ypos 120 xpos 70

    text _("{size=55}{font=GlowSans-Bold.otf}Bond Points{/font}  [bondexp02]{/size}") ypos 220 xpos 70

    frame:
            background None
            side ("c r"):
                area (40,320,550,600)
                viewport id "eventlist_scroller02": #REMEMBER YOUR VIEWPORT ID SO THE SCROLLBAR IS PLACED FOR IT
                    draggable True mousewheel True
                    grid 1 8:
                        xalign 0.5
                        yalign 0.5
                        ...
                        if bond02 <= 2:
                            frame:
                                ...
                                xsize 500
                                ysize 112
                                text _("{size=30}Bond Story 3{/size}"):
                                    yalign 0.5
                                    xpos 20
                        ...
                        if terrance_jerk_seen == False:
                            frame:
                                background "images/workday/choice_box_ss.png"
                                xsize 500
                                ysize 112
                                text _("{size=30}Secret Grove{/size}"):
                                    yalign 0.5
                                    xpos 20
                        
                        if terrance_jerk_seen == True:
                            frame:
                                background "images/workday/choice_box_ss2.png"
                                xsize 500
                                ysize 112
                ...
                vbar value YScrollValue("eventlist_scroller02") #TAKES YOUR VIEWPORT ID AS THE ARG
...
screen bond03:
    ...
    text _("{size=55}{font=GlowSans-Bold.otf}Bond Level{/font}  [bond03]{/size}") ypos 120 xpos 70

    text _("{size=55}{font=GlowSans-Bold.otf}Bond Points{/font}  [bondexp03]{/size}") ypos 220 xpos 70

    frame:
            background None
            side ("c r"):
                area (40,320,550,600)
                viewport id "eventlist_scroller03": #REMEMBER YOUR VIEWPORT ID SO THE SCROLLBAR IS PLACED FOR IT
                    draggable True mousewheel True
                    grid 1 8:
                        xalign 0.5
                        yalign 0.5
                        ...
                        if bathhouse_odachi_done == False:
                            frame:
                                background "images/workday/choice_box_ss.png"
                                xsize 500
                                ysize 112
                                text _("{size=30}Bathhouse Encounter{/size}"):
                                    yalign 0.5
                                    xpos 20
                        
                        if bathhouse_odachi_done == True:
                            frame:
                                background "images/workday/choice_box_ss2.png"
                                xsize 500
                                ysize 112
                ...
                vbar value YScrollValue("eventlist_scroller03") #TAKES YOUR VIEWPORT ID AS THE ARG
...
screen bond04:
    ...
    text _("{size=55}{font=GlowSans-Bold.otf}Bond Level{/font}  [bond04]{/size}") ypos 120 xpos 70

    text _("{size=55}{font=GlowSans-Bold.otf}Bond Points{/font}  [bondexp04]{/size}") ypos 220 xpos 70

    frame:
            background None
            side ("c r"):
                area (40,320,550,600)
                viewport id "eventlist_scroller04": #REMEMBER YOUR VIEWPORT ID SO THE SCROLLBAR IS PLACED FOR IT
                    draggable True mousewheel True
                    grid 1 8:
                        xalign 0.5
                        yalign 0.5
                ...
                vbar value YScrollValue("eventlist_scroller04") #TAKES YOUR VIEWPORT ID AS THE ARG
...
screen bond05:
    ...
    text _("{size=55}{font=GlowSans-Bold.otf}Bond Level{/font}  [bond05]{/size}") ypos 120 xpos 70

    text _("{size=55}{font=GlowSans-Bold.otf}Bond Points{/font}  [bondexp05]{/size}") ypos 220 xpos 70

    frame:
            background None
            side ("c r"):
                area (40,320,550,600)
                viewport id "eventlist_scroller05": #REMEMBER YOUR VIEWPORT ID SO THE SCROLLBAR IS PLACED FOR IT
                    draggable True mousewheel True
                    grid 1 8:
                        xalign 0.5
                        yalign 0.5
                ...
                vbar value YScrollValue("eventlist_scroller05") #TAKES YOUR VIEWPORT ID AS THE ARG
...
screen bond06:
    ...
    text _("{size=55}{font=GlowSans-Bold.otf}Bond Level{/font}  [bond06]{/size}") ypos 120 xpos 70

    text _("{size=55}{font=GlowSans-Bold.otf}Bond Points{/font}  [bondexp06]{/size}") ypos 220 xpos 70

    frame:
            background None
            side ("c r"):
                area (40,320,550,600)
                viewport id "eventlist_scroller06": #REMEMBER YOUR VIEWPORT ID SO THE SCROLLBAR IS PLACED FOR IT
                    draggable True mousewheel True
                    grid 1 8:
                        xalign 0.5
                        yalign 0.5
                        ...
                        if marcus_sxp_1 == False:
                            frame:
                                ...
                                xsize 500
                                ysize 112
                                text _("{size=30}Special Oil{/size}"):
                                    yalign 0.5
                                    xpos 20
                        
                        if marcus_sxp_1 == True:
                            frame:
                                background "images/workday/choice_box_ss2.png"
                                xsize 500
                                ysize 112
                ...
                vbar value YScrollValue("eventlist_scroller06") #TAKES YOUR VIEWPORT ID AS THE ARG
...
screen bond07:
    ...
    text _("{size=55}{font=GlowSans-Bold.otf}Bond Level{/font}  [bond07]{/size}") ypos 120 xpos 70

    text _("{size=55}{font=GlowSans-Bold.otf}Bond Points{/font}  [bondexp07]{/size}") ypos 220 xpos 70

    frame:
            background None
            side ("c r"):
                area (40,320,550,600)
                viewport id "eventlist_scroller07": #REMEMBER YOUR VIEWPORT ID SO THE SCROLLBAR IS PLACED FOR IT
                    draggable True mousewheel True
                    grid 1 8:
                        xalign 0.5
                        yalign 0.5
                        ...
                        if bathhouse_khaleb_done == False:
                            frame:
                                background "images/workday/choice_box_ss.png"
                                xsize 500
                                ysize 112
                ...
                vbar value YScrollValue("eventlist_scroller07") #TAKES YOUR VIEWPORT ID AS THE ARG
...
screen bond08:
    ...
    text _("{size=55}{font=GlowSans-Bold.otf}Bond Level{/font}  [bond08]{/size}") ypos 120 xpos 70

    text _("{size=55}{font=GlowSans-Bold.otf}Bond Points{/font}  [bondexp08]{/size}") ypos 220 xpos 70

    frame:
            background None
            side ("c r"):
                area (40,320,550,600)
                viewport id "eventlist_scroller08": #REMEMBER YOUR VIEWPORT ID SO THE SCROLLBAR IS PLACED FOR IT
                    draggable True mousewheel True
                    grid 1 8:
                        xalign 0.5
                        yalign 0.5
                        ...
                        if fguards_sxp_1 == False:
                            frame:
                                ...
                                xsize 500
                                ysize 112
                                text _("{size=30}Tail Service 1{/size}"):
                                    yalign 0.5
                                    xpos 20
                        
                        if fguards_sxp_1 == True:
                            frame:
                                background "images/workday/choice_box_ss2.png"
                                xsize 500
                                ysize 112
                        ...
                        if cguards_sxp_1 == False:
                            frame:
                                ...
                                xsize 500
                                ysize 112
                                text _("{size=30}Tail Service 2{/size}"):
                                    yalign 0.5
                                    xpos 20
                        
                        if cguards_sxp_1 == True:
                            frame:
                                background "images/workday/choice_box_ss2.png"
                                xsize 500
                                ysize 112
                        ...
                        if eguards_sxp_1 == False:
                            frame:
                                ...
                                xsize 500
                                ysize 112
                                text _("{size=30}Tail Service 3{/size}"):
                                    yalign 0.5
                                    xpos 20
                        
                        if eguards_sxp_1 == True:
                            frame:
                                background "images/workday/choice_box_ss2.png"
                                xsize 500
                                ysize 112
                        ...
                        if sguards_sxp_1 == False:
                            frame:
                                ...
                                xsize 500
                                ysize 112
                                text _("{size=30}Tail Service 4{/size}"):
                                    yalign 0.5
                                    xpos 20
                ...
                vbar value YScrollValue("eventlist_scroller08") #TAKES YOUR VIEWPORT ID AS THE ARG
...
screen bond10:
    ...
    text _("{size=55}{font=GlowSans-Bold.otf}Bond Level{/font}  [bond10]{/size}") ypos 120 xpos 70

    text _("{size=55}{font=GlowSans-Bold.otf}Bond Points{/font}  [bondexp10]{/size}") ypos 220 xpos 70

    frame:
            background None
            side ("c r"):
                area (40,320,550,600)
                viewport id "eventlist_scroller10": #REMEMBER YOUR VIEWPORT ID SO THE SCROLLBAR IS PLACED FOR IT
                    draggable True mousewheel True
                    grid 1 8:
                        xalign 0.5
                        yalign 0.5
                        ...
                        if mjolnik_generic_massage_done == False:
                            frame:
                                background "images/workday/choice_box_ss.png"
                                xsize 500
                                ysize 112
                                text _("{size=30}Visits Mjolnik 1{/size}"):
                                    yalign 0.5
                                    xpos 20
                        
                        if mjolnik_generic_massage_done == True:
                            frame:
                                background "images/workday/choice_box_ss2.png"
                                xsize 500
                                ysize 112
                        ...
                        if mjolnik_generic_cooking_done == False:
                            frame:
                                background "images/workday/choice_box_ss.png"
                                xsize 500
                                ysize 112
                                text _("{size=30}Visits Mjolnik 2{/size}"):
                                    yalign 0.5
                                    xpos 20
                        
                        if mjolnik_generic_cooking_done == True:
                            frame:
                                background "images/workday/choice_box_ss2.png"
                                xsize 500
                                ysize 112
                        ...
                        if mjolnik_generic_chores_done == False:
                            frame:
                                background "images/workday/choice_box_ss.png"
                                xsize 500
                                ysize 112
                                text _("{size=30}Visits Mjolnik 3{/size}"):
                                    yalign 0.5
                                    xpos 20
                        
                        if mjolnik_generic_chores_done == True:
                            frame:
                                background "images/workday/choice_box_ss2.png"
                                xsize 500
                                ysize 112
                        ...
                        if mjolnik_haystack_2_done == False:
                            frame:
                                background "images/workday/choice_box_ss.png"
                                xsize 500
                                ysize 112
                                text _("{size=30}Visits Mjolnik 4{/size}"):
                                    yalign 0.5
                                    xpos 20
                        
                        if mjolnik_haystack_2_done == True:
                            frame:
                                background "images/workday/choice_box_ss2.png"
                                xsize 500
                                ysize 112
                        ...
                        if mjolnik_massage_front_done == False:
                            frame:
                                background "images/workday/choice_box_ss.png"
                                xsize 500
                                ysize 112
                                text _("{size=30}Visits Mjolnik 5{/size}"):
                                    yalign 0.5
                                    xpos 20
                        
                        if mjolnik_massage_front_done == True:
                            frame:
                                background "images/workday/choice_box_ss2.png"
                                xsize 500
                                ysize 112
                        ...
                        if mjolnik_gold_in_field_done == False:
                            frame:
                                background "images/workday/choice_box_ss.png"
                                xsize 500
                                ysize 112
                                text _("{size=30}Visits Mjolnik 6{/size}"):
                                    yalign 0.5
                                    xpos 20
                        ...
                        if mjolnik_cooking_fruit_done == False:
                            frame:
                                background "images/workday/choice_box_ss.png"
                                xsize 500
                                ysize 112
                                text _("{size=30}Ember Fruit{/size}"):
                                    yalign 0.5
                                    xpos 20
                        
                        if mjolnik_cooking_fruit_done == True:
                            frame:
                                background "images/workday/choice_box_ss2.png"
                                xsize 500
                                ysize 112
                ...
                vbar value YScrollValue("eventlist_scroller10") #TAKES YOUR VIEWPORT ID AS THE ARG
