                ...
                grid 2 6:
                    ...
                    if ember_fruit >= 1:
                        frame:
                            ...
                            xalign 0
                            yalign 0.5
                            textbutton "{color=#ffffff}{size=50}{font=GlowSans-Bold.otf}Ember Fruit{/font}{/size}{/color}\n{color=#d6d6d6}{size=28}{font=GlowSans-Regular.otf} {/font}{/size}{/color}\n{size=28}Amount Left  [ember_fruit]{/size}":
                                xalign 0
                                yalign 0
                                xpos 200
                                action ShowMenu('item08')
...
screen item08:
    ...
    image "dragonfruit_01":
        zoom 0.5
        ypos 200
        xalign 0.5

    text _("{size=40}{font=GlowSans-Regular.otf}A flame-shaped fruit, radiating a subtle warmth.\nMurry said they needed to be cut up and have the seeds removed before eaten. \n\nIt might catch the interest of someone with a passion for fruits and vegetables... {/font}{/size}") ypos 500 xalign 0.5

    textbutton _("{size=40}{font=GlowSans-Bold.otf}Return{/font}{/size}") ypos 955 xpos 50 action Hide("item08", dissolve)