...
label c5t_cg3:
    ...
    show tiger_s3_01 at vshake (0.08, 0, -10)
    ...
    #2)
    camera :    
        ease 1 zpos -120 xpos 60 ypos -30
...
label c5t_cg3_result :
    ...
    if c5t_touch_true == 3  :
        ...
        ## 홍차
        show tea :
            zoom 0.98 xpos 0.55 ypos 0.495 zpos -185
        with dissolve
...
label c5t_cg3_result_next :
    ...
    #23)
    camera :
        ease 1 zpos -150 xpos 100 ypos 70
    pause 1.0
...
label c5t_cg4:
    ...
    scene bg tiger_s4_background :
        zoom 0.5
        zpos -958

    show tiger_s4_back_shelf :
        zoom 0.4
        zpos -500
    ...
    hide tiger_s4_surprise
    hide tiger_s4_tigerbeat
    with dissolve
...
label c5t_after:
    ...
    c out_d sigh "(집에 돌아가면 제대로 씻어야겠다.)" id c05_t_0914
