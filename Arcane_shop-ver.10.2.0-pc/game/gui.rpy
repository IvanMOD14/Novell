...
#############################################################################
init python:
    renpy.music.register_channel("channel1", "sfx", loop=False)
    renpy.music.register_channel("channel2", "sfx", loop=False)
...
## 인-게임 글자에 사용됩니다.
define gui.text_font = "NotoSansKR-Medium.otf"

## 캐릭터의 이름에 사용됩니다.
define gui.name_text_font = "NotoSansKR-Bold.otf"

## 인터페이스에 사용됩니다.
define gui.interface_text_font = "NotoSansKR-Medium.otf"

## 인터페이스 내부 상단(화면모드 같은거) 글자 크기.
define gui.label_text_font = "NotoSansKR-Bold.otf"
...
## 게임의 타이틀(title) 글자의 폰트입니다.
define gui.title_text_font = "SSShinb7Regular_otf.otf"
...
## 번역시 사용될 폰트와 폰트 크기들 설정 ################################################


translate english python:

    gui.namebox_borders = Borders(5, 5, 5, 7)


translate chinese_simple python:

    gui.text_font = "Source Han Sans CN Normal.otf"
    gui.name_text_font = "Source Han Sans CN Bold.otf"
    gui.interface_text_font = "Source Han Sans CN Medium.otf"
    gui.label_text_font = "Source Han Sans CN Bold.otf"
    gui.title_text_font = "Source Han Sans CN Bold.otf"
    gui.choice_button_text_font = "Source Han Sans CN Bold.otf"
    gui.namebox_borders = Borders(5, 6, 5, 5)
    gui.name_ypos = 0.00
...
image main_movie :
    Movie(play ="gui/main_mv.mov", size = (1931,1086))
    yoffset -3


define gui.main_menu_background = "main_movie"
define gui.game_menu_background = "main_menu_back2"
...
define gui.name_xpos = 0.16
define gui.name_ypos = 0.025

## 캐릭터들의 이름을 수평으로 정렬합니다. 이것은 0.0으로 좌측 정렬, 0.5로 중앙,
## 그리고 1.0으로 우측 정렬될 수 있습니다.
define gui.name_xalign = 1
...
## 합니다.
define gui.namebox_borders = Borders(5, 5, 5, 6)
...
define gui.choice_button_text_idle_color = "#3a3a3aca"
...
init python:
    ...
    def touch():
        ...
        gui.quick_button_borders = Borders(30, 21, 30, 0)
