...
init python:
    ...
    class SnowParticle(object):
        ...
        """
        def __init__(self, image, wind, speed, xborder, yborder, rotation_speed):
            """
            ...
            self.rotation_speed = rotation_speed  # 회전 속도
            self.rotation = 1  # 초기 회전 각도
        ...
        def update(self, st):
            ...
            # 회전 업데이트
            self.rotation += self.rotation_speed * lag
            self.rotation = self.rotation % 360  # 회전 값이 0-360도 범위 내에 있도록 보장
