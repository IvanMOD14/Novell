...
init python:
    ...
    if renpy.mobile:
        # 이미지 캐시 크기 조절
        config.image_cache_size = 64  # 모바일은 더 작게 설정
...
#     config.cache_surfaces = False
    ...
    config.after_load_callbacks.append(cleanup_memory)
...
define config.name = _("Arcane shop")
...
define config.version = "ver.10.0.1"
...
define config.main_menu_music = "audio/Rinne - Stopped time.mp3"
...
define config.intra_transition = Dissolve(.35)
...
define config.save_directory = "arcane_shop"
