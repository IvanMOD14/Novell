...
#init python:
    ...
    #def gunther_callback(event, interact=True, **kwargs):
            ...
            #renpy.sound.queue("audio/silence.wav", channel="beeps", loop=False)
...
label bondexpdown01:
    play sound "audio/bondexpdown.wav"
...
label bondexpdown06:
    play sound "audio/bondexpdown.wav" volume 2.0
...
label start:
    ...
    scene bg black
    with s_dissolve
    play music "audio/Thunder Storm 2.wav" volume 1.0 fadein 3.0
...
show ratio1
with s_dissolve
play music "audio/maou_bgm_ethnic02.mp3" volume 1.0 fadein 3.0
