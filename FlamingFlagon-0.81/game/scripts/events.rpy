...
label unlock_personal_service:
    ...
    play music "audio/Vargr.mp3" volume 1.0 fadein 3.0
    with dissolve
...
label fen_masturbate_01:
    ...
    play music "audio/stroking_slow_rhythmic_01.wav" volume 1.0 fadein 3.0
    ...
    play sound "audio/light moan 1.wav" volume 1.0 loop fadein 3.0
    ...
    label about_fen_jerking_solo:
        ...
        hide fen
        with dissolve
        play music "audio/stroking_fast_rhythmic_01.wav" volume 1.0 fadein 3.0
        ...
        play sound "audio/light climax 1.wav" volume 1.0
...
label fen_masturbate_02:
    ...
    show bg fenroom at truecenter:
        zoom 1
    with dissolve
    play sound "audio/Door Open 2.wav" volume 1.0
    ...
    label gunther_decline_sex1:
        ...
        hide gunther
        with dissolve
        play sound "audio/Door Close.wav" volume 1.0
...
label fen_tailservice_00:
    ...
    play music "audio/Green Wolf Inn.mp3" volume 1.0 fadein 3.0
...
label fen_tailservice_fussyguard:
    ...
    play music "audio/light moan 1.wav" volume 0.5 fadein 1.0
    ...
    play sound "audio/payment.wav" volume 3.0
...
label fen_tailservice_energeticguard:
    ...
    play music "audio/Schlop.ogg" volume 2.0 fadein 1.0
    play nsfw1 "audio/light moan 1.wav" volume 1.0 fadein 1.0
...
label fen_tailservice_stoicguard:
    ...
    stop music fadeout 0.5
    play vocal1 "audio/light climax 1.wav" volume 1.0
...
label gunther_nsfw_01a:
    ...
    with s_dissolve
    play music "audio/light moan 1.wav" volume 2.0 fadein 1.0
    ...
    with s_dissolve
    play sound "audio/light climax 1.wav" volume 1.0
    play vocal1 "audio/deep climax 1.wav" volume 1.0
    stop music fadeout 0.5
    stop nsfw1 fadeout 0.5
    play fuck "audio/fuck mid 1.ogg" volume 1.0
    play ball "audio/ball hits 1.ogg" volume 2.0
    ...
    with s_dissolve
    play sound "audio/Transition1.mp3" volume 1.0
...
label gunther_nsfw_01b:
    ...
    play sound "audio/Slap 5.wav" volume 2.0
    ...
    with s_dissolve
    play music "audio/light moan 1.wav" volume 1.0 fadein 1.0
    play nsfw1 "audio/deep growls 1.wav" volume 1.0 fadein 1.0
    play fuck "audio/fuck mid 1.ogg" volume 1.0
    play ball "audio/ball hits 1.ogg" volume 2.0
    ...
    with s_dissolve
    play music "audio/light moan 3.wav" volume 1.0 fadein 1.0
    play nsfw1 "audio/deep growls 1.wav" volume 2.0 fadein 1.0
    play fuck "audio/fuck fast 1.ogg" volume 2.0
    play ball "audio/ball hits 2.ogg" volume 2.0
    ...
    label gunther_nsfw_01b_again:
        ...
        play music "audio/Irish Sea.mp3" volume 1.0 fadein 3.0
...
label gunther_event_01:
    ...
    play sound "audio/Transition2.mp3" volume 1.0
    scene bg tavern3
...
label gunther_event_03:
    ...
    with s_dissolve
    play music "audio/Sir Gawain.mp3" volume 1.0 fadein 3.0
...
label gunther_bond_02:
    ...
    show gunther normal at top:
        zoom 1.5
    with s_dissolve
    play sound "audio/pour drink.mp3" volume 3.0
    ...
    play sound "audio/drink.wav" volume 2.0
    ...
    show bg tavern1
    with dissolve
    play sound "audio/glass clink.wav" volume 3.0
...
label gunther_unlockcooking:
    ...
    Gunther "Oh, what about it?"

    Fen "I've got some ideas to expand our selections."

    Gunther "Really? The food has really started drawing more people over. That sounds like a grand idea."

    Fen "Great! I'll need to get some more ingredients in the kitchen, a place to test new recipes, and someone to help test out new recipes."

    #Gunther grinning
    Gunther "You've done so much for the Flagon, I'd be more than happy to assist you with tasting."

    Fen "Thanks, I'll need to spend more time in the kitchen."

    Gunther "That's fine, just don't burn yourself out."

    Fen "I can handle it, something about it feels so familiar. Even though my mind may not remember, it seems my muscles do."

    Gunther "If it can help your memory, I'm all for it. Just be sure not to waste too many ingredients, we don't have a large starting budget."

    Fen "Understood."

    Fen "Let's start with something easy and tasty."
...
label niall_intro:
    ...
    play music "audio/Excalibur.mp3" volume 1.0 fadein 3.0
    ...
    show niall lick
    play sound "audio/drink.wav" volume 3.0
...
label niall_talk_01:
    ...
    label about_Niall_check_in:
        ...
        Niall "I'll be honest, I don't know how I would've kept going on without all these delicious snacks, if I decided to stay away."

        Fen "Right? And there'll be plenty more kinds to come soon, too. So, I hope your stomach's ready."

        Niall "Oh, yes~! That's what I'm talking about!"

        Niall "And you could look forward to great things in the future with me, too."

        Niall "I've already been putting in a heck of a lot more work toward my physical training, if you hadn't noticed."
        ...
        Niall "Yeah, I can't have you needing to cheer me up like I'm some little kid every time I stumble and fall."

        Niall "The road upward's full of all kinds of unexpected twists and lows; it's that way no matter what it is you're trying to do."

        Niall "And for that, I need to be ready to face mine, whatever they are, and learn how to be confident enough to pick myself up again."

        Niall "That's the conclusion I came to after giving what happened before between you and me a whole lot of thought!"

        Fen "Wow, that's a pretty good mindset you got there, actually. Colour me impressed."
        ...
        Niall "Thanks, [name]. You're a really awesome guy."
        ...
        label about_Niall_hug_friends:
            ...
            "I just wanted to ask you about it to make sure, though. You get it, yeah?"

            Fen "Oh. Yeah, definitely."

            Niall "Cool."

            "But anyway, I don't plan on making you need to cheer me up like I'm some little kid like back there every time I stumble and fall."

            "The road upward's full of all kinds of unexpected twists and lows; it's that way no matter what it is you're trying to do."

            "And for that, I need to be ready to face mine, whatever they are, and learn how to be confident enough to pick myself up again."

            "That's the conclusion I came to after giving what happened before between you and me a whole lot of thought!"

            Fen "Wow, that's a pretty good mindset you got there, actually. Colour me impressed."

            "Well, just know that I'm always open to hear whatever you might need me to, if you're ever feeling unsure about something again."

            Niall "Thanks, [name]. You're a really awesome guy."

            "I'm so grateful you're willing to be my inspiration. I swear I won't let you down!"

        label about_Niall_hug_type:
            #Niall Bond down.
            Niall shock "O-Oh...! Uh..."

            Niall stress "Damn...I was afraid it might've been like that. I'm so sorry."

            Fen "Sorry? What for? You're a great guy! Always so bright and charming, it's like I can't get enough."

            Fen hot "It even had me wondering, if—Hehe!—We might, maybe end up something more than friends someday...?"
            ...
            Fen shock "Oh! Oh, no! Niall, I take it all back! I'm so sorry!"
        ...
        label about_Niall_hug_unsure:
            ...
            "And...I'm just really happy it worked, I guess. Heh-heh!"
            ...
            Niall "Speaking of which, my plan is to make it so you don't need to cheer me up every time I stumble and fall like you did back there."

            Niall wink "Not that I didn't appreciate the save, though."

            Niall "It's just that the road upward's full of all kinds of unexpected twists and lows; it's that way no matter what it is you might be trying to do."
...
label niall_bond_02:
    ...
    Gunther "The boy's exaggerating a bit."
    ...
    Niall grin "With this special Orichalcum relic, I plan on someday taking on a quest that will make me as mythic and brave as you."

    Niall "That is my one and only dream. I wanna go down in history!"

    Gunther stern "..."

    Fen grin "Ahaha! Oh, man. That's such a wild dream! But that's so exactly like you, Niall."

    Niall "Mhm. I know right. But hey, you gotta be willing to reach for the stars if you want people to start believing that's where you belong, right?"

    Fen "Heh, yeah, I guess."

    Fen "How about it, Gunther? You think Niall's showing what it takes to follow in your big footsteps?"
    ...
    Gunther "We're done here for tonight."
    ...
    Fen "I can't tell exactly how much of what he said was true, but you shouldn't be so dismissive."

    Gunther "Sorry, tavern's closed, and I've got some urgent business I just remembered I need to tend to."
    ...
    Gunther "I'm sorry... but at the end of the day, all these 'heroes' of yours are just foolish folks doing whatever they can to survive."
    ...
    Niall cry2 "I said I want to leave!!!"
    ...
    Gunther "But I couldn't bring myself to crush his poor, little dreams like that."

    Fen "Niall waited just for you all this time, though. I think the main reason why he came here in the first place was because of you."

    Fen "I remember you said adventuring isn't without its risks, but..."

    Fen "Niall's a good lad, you could..."

    Gunther "Just drop it, pup. It's for the best that stuff like this stays between me and the floorboards."
    ...
    Gunther "I've seen guys of his type before; they don't give up on the people who help them out so easily..."

    Fen "So, what then? That's it?"

    Gunther "Yep. Oh, but don't worry about finishing the rest of closing for tonight. I'll get to it in a minute."

    Gunther "Just go on over to bed."

    Fen stern "..."

    Gunther "...Ugh. Fine, then. Good night."
    ...
    "Instead, you sneak out the back door and make your way through the streets in the direction where you saw Niall run."
    ...
    "He jolts as soon as he hears you calling and then scrambles to his feet, looking like he might try to run away again."
    ...
    Niall "Yeah? And how would you know? You've never been an adventurer, right?"
    ...
    Niall "Many just end up killed and eaten by monsters at some point, or use their wealth and power to become tyrants, or get corrupted by fame..."

    Niall cry2 "And he knew...Just from one look at me, he knew I'd never ever get to be as great as him."
    
    Fen "Niall—"

    Niall cry2 "Almost no one does! It just makes sense!"

    Niall "It...It just makes stupid sense...An–And I couldn't see it!"

    Niall "I couldn't see it..."

    Fen "..."

    Fen "Niall, maybe being an adventurer just isn't the right calling for you."

    Fen "And if so, then it's okay. You can find lots of other things to put your passion towards."

    Niall angry "But whose is it, then!?"

    Niall "What is it even supposed to take to be the right kind of person for going out and doing some damn good in the world?"
    
    Fen shock "U-Uh..."

    Niall "Whose job is it to decide that? What are they doing with it, anyway?"

    Niall "Every day, I doubt myself—questioning the things I do and the choices I make..."
    ...
    Niall "So totally different from how I always try to be, because I know that people might hate me if they knew I actually thought like that."

    Niall "You...You can hate me too now for it, if you want."
    ...
    Fen "I never will for something like this."
    
    Fen "And even if Gunther doesn't believe in you—thinks you'll never get to be an adventurer—that shouldn't matter, because..."
    
    Fen "Because I believe in you."

    Niall shock "!!!"

    Fen "All those talks we had about kindness and dreams couldn't have just been for nothing; not when you haven't even really tried."
    ...
    Fen "You could say that hearing all your stories ended up inspiring me in just that kind of way."

    Fen "And it wouldn't be very heroic of you to just turn your back on an admirer who's still waiting to hear all about your first great deed, now would it?"
    ...
    label about_Niall_pat:
        ...
        Niall "And... I get it now, Gunther was just worried about me. In his eyes, I'm still inexperienced."
        ...
        Niall "Mhm, for sure! You can count on it."

        Niall "After all, if you're gonna be so excited to hear tales of my valiant exploits once they're made..."
    ...
    label about_Niall_hug:
        ...
        Niall blush "Does this mean that you..."

        Fen "Hm?"

        Niall "N-No, nothing. It was just a stupid idea."
...
label terrance_intro:
    ...
    play music "audio/The Tale.mp3" volume 1.0 fadein 3.0
...
label terrance_bond_02:
    ...
    scene bg fenroom
    play music "audio/Irish Sea.mp3" volume 1.0 fadein 3.0
    play sound "audio/knock door.wav" volume 1.0
    ...
    play sound "audio/mopping.wav" volume 1.0 loop fadein 2.0
    ...
    label terrance_bond_01_yes2:
        ...
        with s_dissolve
        play sound "audio/deep growls 1.wav" volume 0.5 fadein 1.0 loop
        ...
        scene terrance cg1 11 at truecenter:
            zoom 1.2
        with s_dissolve
        play sound "audio/deep growls 1.wav" volume 1.0 fadein 1.0 loop
    ...
    label terrance_bond_01_no3:
        ...
        play sound "audio/deep climax 1.wav" volume 2.0
        ...
        play sound "audio/deep climax 1.wav" volume 1.0
    ...
    label terrance_bond_01_yes4:
        ...
        play sound "audio/light moan 1.wav" volume 1.0 fadein 3.0 loop
...
label terrance_bond_03:
    ...
    play sound "audio/light moan 1.wav" volume 0.5 loop fadein 3.0
    ...
    play music "audio/Winter Morning.mp3" volume 1.0 fadein 3.0
    ...
    menu:
        ...
        "Tell me more.":
            ...
            play sound "audio/Punch.wav" volume 1.0
            stop music fadeout 0.5
            ...
            menu:
                ...
                "Indulge him.":
                    ...
                    play sound "audio/light moan 3.wav" volume 0.5 loop fadein 3.0
                    ...
                    play sound "audio/light moan 3.wav" volume 1.0 loop fadein 3.0
                    ...
                    stop nsfw1 fadeout 3.0
                    play vocal1 "audio/deep climax 2.wav" volume 0.5
...
label odachi_intro:
    ...
    show bg tavern4_blur
    with s_dissolve
    play music "audio/Winter Sakura.mp3" volume 1.0 fadein 3.0
...
label odachi_bond_02a:
    ...
    menu:
        ...
        "Stay hidden and watch what happens.":
            ...
            play music "audio/The Ranger's Tavern.mp3" volume 1.0 fadein 3.0
            show bg tavern1
            with s_dissolve
...
label private_bath1:
    ...
    stop music fadeout 3.0
    play music "audio/bathtubambient.wav" volume 1.0 fadein 3.0
    ...
    play music "audio/bathtubambient.wav" volume 0.2 fadein 3.0
    hide fen
    hide marcus
    ...
    play sound "audio/light moan 1.wav" volume 1.0 loop fadein 1.0
    ...
    play sound "audio/light moan 1.wav" volume 1.3 loop fadein 1.0
    play fuck "audio/fuck fast 1.ogg" volume 1.0
    play ball "audio/ball hits 2.ogg" volume 2.0
    #Fuck faster now
...
label bathhouse_common:
    ...
    if commonpool_event == 'odachi':
        ...
        if odachi_bathhouse_first == False:
            ...
            play sound "audio/big splash.wav" volume 1.0
            show bg bathhouse1_blur
            with dissolve
    ...
    if commonpool_event == 'niall':
        ...
        if niall_bathhouse_first == False:
            ...
            play sound "audio/big splash.wav" volume 2.0
    ...
    if commonpool_event == 'khaleb':
        ...
        label about_trei_wrestle:
            ...
            if FenSTR <= 5:
                ...
                play sound "audio/clapping.wav" volume 1.0
                $ bondexp07 += 3
        ...
        label bathhouse_khaleb_end:
            stop sound fadeout 1.0
            stop music fadeout 1.0
            play sound "audio/Door Open 2.wav" volume 2.0
            show bg bathhouse1 at truecenter:
                zoom 1
            hide ratio1
            hide trei
...
label bathhouse_luxury:
    ...
    #Add random encounters here!!!
    #'common', 'common', '???',
    #$ luxurypool_event = renpy.random.choice(['common', '???','???'])
...
label bathhouse_private:
    ...
    play sound "audio/Slap 1.wav" volume 2.0
